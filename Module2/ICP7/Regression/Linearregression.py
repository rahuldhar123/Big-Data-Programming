...
data = spark.read.format("csv").option("header", True).option("inferSchema", True).option("delimiter", ",").load("D:\Drivers\github\Big-Data-Programming\Module2\ICP7\car.csv")
